...
<form action="<%=basePath %>products/save" enctype="multipart/form-data" class="form" method="post" style="width:80%;">
            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        <label>上传视频:</label>
                        <div class="formRight">
                        	<input name="file"  class="form-control" type="file" required value="">                        	
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                        	...
                        	<option value="${item.id }">${item.pid }--${item.title }</option>
