							...
							<div class="card">
								...
								<form method="post" class="card" action="<%=basePath%>members/update2">
									...
									<div class="card-body">
										...
										<img  class="uploadImg " src="<%=basePath%>assets\images\faces\female\25.jpeg"/>
										</c:if>
										<c:if test="${not empty edituser.thumb }">
										<img  class="uploadImg " src="<%=basePath%>${edituser.thumb}"/>
										</c:if>
									...
									<div class="card-footer text-right">
										<div class="d-flex">
											<a href="javascript:parent.location.href='<%=basePath %>manage/index';" class="btn btn-danger">取消</a>
